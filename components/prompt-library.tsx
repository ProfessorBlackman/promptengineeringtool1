    ...
    const fetchPrompts = async () => {
        ...
        try {
            ...
            const mapped: Prompt[] = raw.map((d: any) => ({
                ...
                content: d.content,
                category: d.category,
                is_system_prompt: d.is_system_prompt || false,
                tags: d.tags || [],
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Manage and organize your prompt
                        collection</p>
                </div>
            ...
            <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete the prompt "{pendingDeletePrompt?.title}"? This action
                            cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
