...
export default function PromptRefiner() {
    ...
    const saveRefinedPrompt = async () => {
        if (!user || !selectedPrompt || !analysisResult?.refinedPrompt) {
            toast({
                title: "Cannot save",
                description: "Select a prompt and run analysis first.",
                variant: "destructive"
            })
            return
        }
        ...
        <div className="space-y-6">
                    ...
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <CardDescription>Select an existing prompt or enter a custom one for
                        ...
                        <Tabs value={mode} onValueChange={(value: string) => setMode(value as "existing" | "custom")}>
                            ...
                            <TabsContent value="existing">
                                ...
                                {selectedPrompt && (
                                    <div>
                                        <div
                                            className="p-3 bg-gray-50 dark:bg-gray-800 rounded-md text-sm max-h-40 overflow-y-auto">
                                ...
                                <Tabs defaultValue="suggestions" className="w-full">
                                    ...
                                    <TabsContent value="suggestions" className="space-y-4">
                                        {analysisResult.suggestions.map((suggestion, index) => (
                                            <div key={index} className="p-3 border rounded-lg">
                                                ...
                                                <Badge
                                                    variant={getImpactBadge(suggestion.impact) as any}>{suggestion.impact} impact</Badge>
                                                <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">{suggestion.description}</p>
                                                {suggestion.before && suggestion.after && (
                                                    <div className="space-y-2">
                                                        <div>
                                                            <span
                                                                className="text-xs font-medium text-red-600">Before:</span>
                                                            <div
                                                        ...
                                                        <div>
                                                            <span
                                                                className="text-xs font-medium text-green-600">After:</span>
                                                            <div
                                    ...
                                    <TabsContent value="strengths" className="space-y-2">
                                        ...
                                        {analysisResult.weaknesses.length > 0 && (
                                            <>
                                                <div className="text-sm font-medium mt-4 mb-2">Areas for Improvement:
                                                </div>
                                    ...
                                    <TabsContent value="refined" className="space-y-4">
                                        <div>
                                            ...
                                            <div
                                                className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-md text-sm overflow-hidden">
                                                <div className="prose prose-sm max-w-none dark:prose-invert">
                                                    <MarkdownRenderer content={analysisResult.refinedPrompt}
                                                                      proseSize="sm"/>
                                                </div>
                                            </div>
                                        </div>
            ...
            {showRefinedModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div
                        className="bg-white dark:bg-gray-900 rounded-lg shadow-lg max-w-4xl max-h-max w-full p-6 relative">
                        <button
                ...
                <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"
                  ...
                  <line x1="6" y1="6" x2="18" y2="18"/>
                        ...
                        <div className="prose prose-lg max-w-none dark:prose-invert">
                            <MarkdownRenderer content={analysisResult?.refinedPrompt || "Prompt not available."}
                                                                      proseSize="sm"/>
                        </div>
                    </div>
                </div>
