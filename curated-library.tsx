...
import { Search, Download, Star, TrendingUp, Award, Copy, Eye } from "lucide-react"
import type { CuratedPrompt, Prompt } from "@/app/dashboard/page"

interface CuratedLibraryProps {
  curatedPrompts: CuratedPrompt[]
  onImportPrompt: (prompt: Omit<Prompt, "id" | "createdAt" | "updatedAt">) => void
}

export function CuratedLibrary({ curatedPrompts, onImportPrompt }: CuratedLibraryProps) {
  ...
  // Mock curated prompts data - in a real app, this would come from an API
  const [mockPrompts] = useState<CuratedPrompt[]>([
    {
      id: "1",
      title: "Creative Story Generator",
      content:
        "Write a {genre} story about {character} who discovers {discovery}. The story should be {length} and include themes of {themes}. Make it engaging and suitable for {audience}.",
      description: "Generate creative stories with customizable parameters for genre, character, and themes.",
      category: "Creative Writing",
      useCase: "Content Creation",
      compatibleModels: ["GPT-4", "GPT-3.5", "Claude", "Gemini"],
      difficulty: "beginner",
      rating: 4.8,
      downloads: 1250,
